            ...
            Malvin.ev.on("connection.update", async (s) => {
                ...
                if (connection === "open") {
                    ...
                    const sid = megaUrl.includes("https://mega.nz/file/")
                        ? 'Mikelae-MD~' + megaUrl.split("https://mega.nz/file/")[1]
                        : 'Error: Invalid URL';
...
💡 *Whats Next?* 
1️⃣ Explore all the cool features of Mikelae-zw-MD.
2️⃣ Stay updated with our latest releases and support.
3️⃣ Enjoy seamless WhatsApp automation! 🤖  

🔗 *Join Our Support Channel:* 👉 [Click Here to Join](https://whatsapp.com/channel/0029Vb8Ho0vD38CadOw1BT2S) 

⭐ *Show Some Love!* Give us a ⭐ on GitHub and support the developer of: 👉 [Mikelae ZW GitHub Repo](https://github.com/ncube3153-rgb/)  

🚀 _Thanks for choosing Mikelae-zw-MD — Let the automation begin!_ ✨`;
